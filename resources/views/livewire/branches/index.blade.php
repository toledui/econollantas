<div class="flex-1 overflow-y-auto p-8 relative" x-data="{
 ...
 $wire.delete(id);
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <!-- Filters & Search -->
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 mb-6 transition-colors">
        ...
        <!-- Branches Table -->
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden transition-colors">
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-200">
                            <th class="px-6 py-4 text-xs uppercase tracking-wider font-bold text-slate-500">
                                Sucursal</th>
                            <th class="px-6 py-4 text-xs uppercase tracking-wider font-bold text-slate-500">
                                Contacto</th>
                            <th class="px-6 py-4 text-xs uppercase tracking-wider font-bold text-slate-500">
                            ...
                            <th class="px-6 py-4 text-xs uppercase tracking-wider font-bold text-slate-500">
                                Estado</th>
                            <th class="px-6 py-4 text-xs uppercase tracking-wider font-bold text-slate-500 text-right">
                                Acciones</th>
                        </tr>
                    </thead>
