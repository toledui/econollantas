<div class="space-y-8">
    ...
    <section
        class="relative rounded-xl overflow-hidden flex flex-col md:flex-row items-center p-8 md:p-12 shadow-lg border border-primary/20 bg-cover bg-center bg-no-repeat"
        style="background-image: url('{{ asset('storage/' . \App\Modules\Settings\Models\Setting::get('dashboard_banner', 'fondo-econollantas.jpeg')) }}');">

        <!-- Overlay -->
        <div class="absolute inset-0 bg-slate-900/70"></div>

        <div class="flex-1 relative z-10 text-white space-y-4">
        ...
        <div class="relative w-full md:w-1/3 mt-8 md:mt-0 flex justify-center items-center z-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section class="lg:col-span-1 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-background-light p-4 rounded-lg border border-slate-100">
                ...
                <div
                    ...
                    <div class="p-5 flex-1 flex flex-col">
                        ...
                        <div class="flex items-center gap-2 mb-4 pt-4 border-t border-slate-100">
                            ...
                            <div class="min-w-0">
                                <p class="text-[9px] font-black text-slate-900 truncate uppercase tracking-wider">
