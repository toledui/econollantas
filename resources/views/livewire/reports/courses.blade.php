<div class="space-y-6">
 ...
 <input type="text" wire:model.live.debounce.300ms="search" placeholder="Buscar curso por nombre..."
 ...
 <div class="min-w-0">
 <p class="font-bold text-slate-800 truncate pr-4"
 style="max-width: 300px;">{{ $course->title }}</p>
 <p
 ...
 <span
 class="text-xs font-black text-slate-700 w-8">{{ $efficiency }}%</span>
 </div>
 </td>
 </tr>
 @empty
