<div class="flex-1 overflow-y-auto p-8 relative" x-data="{
 ...
 <input type="text" wire:model.live.debounce.300ms="search" class="w-full bg-slate-50 border-none rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-primary/30 transition-all outline-none" placeholder="Buscar por nombre...">
 </div>
 ...
 <!-- Table Card -->
 <div
 class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden transition-colors">
 <div class="overflow-x-auto">
 <table class="w-full text-left border-collapse">
 <thead>
 <tr class="bg-slate-50/50 border-b border-slate-100">
 <th
 class="px-6 py-4 text-xs uppercase tracking-widest font-bold text-slate-500">
 Usuario</th>
 <th
 class="px-6 py-4 text-xs uppercase tracking-widest font-bold text-slate-500">
 Roles</th>
 ...
 Estado</th>
 <th
 class="px-6 py-4 text-xs uppercase tracking-widest font-bold text-slate-500 text-right">
 Acciones</th>
 </tr>
 </thead>
 ...
 <div
 class="bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-6">
 ...
 <div
 class="md:col-span-2 bg-amber-50 p-6 rounded-3xl border border-amber-100 space-y-4">
 <h4
 class="text-xs font-bold text-amber-700 uppercase tracking-widest flex items-center">
