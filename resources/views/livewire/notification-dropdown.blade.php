<div class="relative" x-data="{ open: false }">
 ...
 <h4
 class="text-sm font-bold text-slate-900 truncate mb-0.5 {{ $isUnread ?' pr-4' :''}}">
 {{ $data['title'] ??' Notificación'}}
 </h4>
 <p class="text-xs text-slate-500 line-clamp-2 leading-relaxed mb-1.5">
 {{ $data['message'] ??''}}
 </p>
 ...
 class="p-1.5 bg-white border border-slate-100 text-slate-400 hover:text-primary hover:border-primary/30 rounded-lg transition-all shadow-sm"
 ...
 <span
 class="material-symbols-outlined text-3xl text-slate-300 mb-3">notifications_off</span>
