<div class="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
 ...
 <span class="material-symbols-outlined mr-1.5 text-primary text-base group-hover:scale-110 transition-transform">category</span>
 Categorías
 </button>
 ...
 <div>
 <label class="block text-xs font-semibold text-slate-500 mb-1.5 uppercase tracking-wider">Categoría</label>
 ...
 <div>
 <label class="block text-xs font-semibold text-slate-500 mb-1.5 uppercase tracking-wider">Estado</label>
 ...
 <div class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden flex flex-col transition-all hover:shadow-xl hover:-translate-y-1 group">
 {{-- Thumbnail --}}
 ...
 <span class="text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-lg bg-primary/10 text-primary">
 ...
 @endphp
 <span class="text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-lg {{ $statusColor }}">
 {{ $statusText }}
 </span>
 </div>
 ...
 <div class="mt-auto flex items-center gap-4 text-xs font-bold text-slate-500 border-t border-slate-100 pt-3">
 ...
 <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[13px]">menu_book</span> {{ $course->lessons_count }} lecciones</span>
 ...
 <div class="flex items-center gap-2">
 <span
 class="text-[10px] font-bold text-slate-400 uppercase">{{ $cat->courses_count ?? 0 }}
 cursos</span>
 @if(!$cat->active)
